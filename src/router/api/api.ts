...
api.post("/update/text", ApiMiddlewares.middlewareUpdateText, ApiMiddlewares.middlewareSendStatusCode200);

api.post("/update/image", ApiMiddlewares.middlewareUploadFiles("files", 1), ApiMiddlewares.middlewareUpdateImage, ApiMiddlewares.middlewareSendStatusCode200);
